...
| start.callSid                | The SID of the Call that started the Stream was started                                                                                     |
...
> **Warning**: The `media.payload` should not contain audio file type header bytes. Providing header bytes causes the media to be streamed incorrectly.
...
Documentation extracted from: https://www.twilio.com/docs/voice/media-streams/websocket-messages
