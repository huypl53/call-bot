...
SYSTEM_MESSAGES = {
    ...
    Language.EN: (
        ...
        "     * startTime: call start time (can use current time)\n"
        ...
        "- Time format: YYYY-MM-DD HH:mm:ss (example: '2025-11-20 10:00:00')\n"
