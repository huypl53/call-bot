...
class ToolService:
    ...
    def get_tool_definitions(self) -> List[RealtimeFunctionToolParam]:
        """
    ...
    def get_tool_definitions_by_names(
        ...
        definitions: List[RealtimeFunctionToolParam] = []
        for name in names:
    ...
    async def execute_tool(
        self, tool_name: str, arguments: Dict[str, Any], session_manager: Any
    ) -> Dict[str, Any]:
        """
